    ...
    void ReDraw()
    {
        ...
        for (int j = 0; j < levelHeight; j++)
        {
            for (int i = levelWidth - 1; i >= 0; i--)
            {
                ...
                //left
                else if (cellState[i, j].state == 13)
                {
                    Vector2 position = cellState[i, j].position;
                ...
                else if (cellState[i, j].state == 15)
                {
                    Vector2 position = cellState[i, j].position;
        ...
        for (int i = 0; i < levelWidth; i++)
        {
            for (int j = 0; j < levelHeight; j++)
            {
                ...
                else if (cellState[i, j].state != 0 && landArray[i, j - 1] == 1)
                {
                    ...
                    float yDistance = endPosition.y - startPosition.y - 3*tileSize;
                    if (yDistance <= 0) {
                        hasRoute = false;
                    }
                    /*
